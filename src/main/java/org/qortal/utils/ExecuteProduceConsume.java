...
public abstract class ExecuteProduceConsume implements Runnable {
	...
	private final AtomicInteger greatestActiveThreadCount = new AtomicInteger(0);
	...
	private final AtomicInteger tasksConsumed = new AtomicInteger(0);
	private final AtomicInteger spawnFailures = new AtomicInteger(0);

	/** Whether a new thread has already been spawned and is waiting to start. Used to prevent spawning multiple new threads. */
	private final AtomicBoolean hasThreadPending = new AtomicBoolean(false);
